...
def COtemperature():
    try:
        ...
        return render_template("COtemperature.html",
                               ...
                               windSpeed=(f"{currentWeather['windKMH']} km/h"))
    except Exception as e:
        loggerError.error(f'flask error: {e}')
        return render_template('error.html')
...
def homeTemperature():
    try:
        ...
        return render_template('homeTemperature.html',
                               ...
                               sypTemp=sypTemp['temperature'],
                               jadTemp=jadTemp['temperature'],
                               lazTemp=lazTemp['temperature'],
                               kotTemp=kotTemp['temperature'],
                               wejTemp=wejTemp['temperature'],
                               iconS1=getIconNameHome(sypTemp['temperature']),
                               iconS2=getIconNameHome(jadTemp['temperature']),
                               iconS3=getIconNameHome(lazTemp['temperature']),
                               iconS4=getIconNameHome(kotTemp['temperature']),
                               iconS5=getIconNameHome(wejTemp['temperature']),
