...
def getCurrentWeatherWA():
    ...
    getCurrentWeatherApi = f'http://api.weatherapi.com/v1/current.json?key={apiKey}&q={locationName}&aqi=yes'
    ...
    pm25 = round(r['air_quality']['pm2_5'],2)
    pm10 = round(r['air_quality']['pm10'],2)
    return(currentWeatherText, currentTemperature, observTime, pm25, pm10)
