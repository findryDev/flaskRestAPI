...
def temperature():
    ...
    print(temperatureS1["temperature"], temperatureS2["temperature"], temperatureS3["temperature"])
    return render_template("temperature.html",
                            temperatureS1=temperatureS1["temperature"],
                            temperatureS2=temperatureS2["temperature"],
                            temperatureS3=temperatureS3["temperature"])
