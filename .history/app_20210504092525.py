...
def homeTemperature():
    ...
    return render_template('homeTemperature.html',
                           ...
                           kotTemp=kotTemp,
                           wejTemp=wejTemp,
                           sensorS1 = getIconNameHome(sypTemp),
                           sensorS2 = getIconNameHome(jadTemp),
                           sensorS3 = getIconNameHome(lazTemp),
                           sensorS4 = getIconNameHome(kotTemp),
                           sensorS5 = getIconNameHome(wejTemp))
