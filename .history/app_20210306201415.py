...
app = Flask(__name__)
postgresql://postgres:1148@localhost:5432/flask
app.config['SQLALCHEMY_DATABASE_URI'] = r"postgresql://33143294_wschodnia4:Fn696129607@https://serwer2071484.home.pl:5432/33143294_wschodnia4"

"""
                                        f'postgresql://{os.getenv("DBUSERNAME")}:'\
                                        f'{os.getenv("PASSWORD")}@'\
                                        f'{os.getenv("SERVER")}:5432/'\
