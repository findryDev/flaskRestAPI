    ...
    try:
        ...
        return render_template('homeTemperature.html',
                               ...
                               currentWeatherObserv=(currentWeather
                                                     ['observTime']),
                               pm25=(currentWeather['currentTemperature']),
                               pm10=(currentWeather['currentTemperature']),
                               weatherImage=(currentWeather['currentTemperature']),
                               windSpeed=(currentWeather['currentTemperature']))
