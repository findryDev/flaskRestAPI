...
def temperature():
    ...
    scriptsDiv.append(bokeh_plot(query=temperatures1,
                                 legendLabel="Temperature sensor 1",
                                 title="Sensor 1",
                                 color='blue'))
    scriptsDiv.append(bokeh_plot(query=temperatures2,
                                 legendLabel="Temperature sensor 2",
                                 title="Sensor 2",
                                 colors='green'))
    scriptsDiv.append(bokeh_plot(query=temperatures3,
                                 legendLabel="Temperature sensor3",
                                 title="Sensor 3",
                                 colors='yellow'))
    scriptsDiv.append(bokeh_plots(models, 100, legendLabels,
