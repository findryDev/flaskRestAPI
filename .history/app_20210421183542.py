...
def temperature():
    ...
    def toPlotsDataSensor2(howMany):
        x = []
        y = []
        lastsElements = ((TemperatureModelSensor2.query.order_by(sqlalchemy.
    ...
    def toPlotsDataSensor3(howMany):
        x = []
        y = []
        lastsElements = ((TemperatureModelSensor3.query.order_by(sqlalchemy.
