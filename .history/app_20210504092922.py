...
def homeTemperature():
    ...
    return render_template('homeTemperature.html',
                           ...
                           kotTemp=kotTemp,
                           wejTemp=wejTemp,
                           sensorS1 = getIconNameHome(sypTemp[0]),
                           sensorS2 = getIconNameHome(jadTemp[0]),
                           sensorS3 = getIconNameHome(lazTemp[0]),
                           sensorS4 = getIconNameHome(kotTemp[0]),
                           sensorS5 = getIconNameHome(wejTemp[0]))
