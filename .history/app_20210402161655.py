...
def temperature():
    ...
    scriptsDiv = []
    scriptsDiv.append(bokeh_plot([TemperatureModelSensor1], 100, ["Sensor1"], "Temperature sensor 1", colors=['blue']))
    scriptsDiv.append(bokeh_plot([TemperatureModelSensor2], 100, ["Sensor2"], "Temperature sensor 2", colors=['green']))
    scriptsDiv.append(bokeh_plot([TemperatureModelSensor3], 100, ["Sensor3"], "Temperature sensor 3"))
    scriptsDiv.append(bokeh_plot(models, 100, legendLabels, "All sensors temperature", colors=['blue','green', 'yellow']))
