    ...
    def getLastFiveRecordToDict(tempModel):
        ...
        for x in temperatureLastFive:
            ...
            dictDateTemp.update(
                {temporeDict['date']: temporeDict['temperature']})
        return dictDateTemp
    print(getLastFiveRecordToDict(TemperatureModelSensor1))
    print(getLastFiveRecordToDict(TemperatureModelSensor2))
    print(getLastFiveRecordToDict(TemperatureModelSensor3))
