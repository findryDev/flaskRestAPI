...
def temperature():
    ...
    temperatureS1LastFive = ((TemperatureModelSensor1.query.order_by(sqlalchemy.desc(TemperatureModelSensor1.id)).limit(5).all()))
    temperatureS1LastFive = (temperatureS1LastFive.query.order_by(sqlalchemy.
                             asc(TemperatureModelSensor1.id)).limit(5).all()).json()
    print(temperatureS1LastFive)
