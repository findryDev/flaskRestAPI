...
def homeTemperature():
    ...
    return render_template('homeTemperature.html',
                           ...
                           kotTemp=kotTemp,
                           wejTemp=wejTemp,
                           sensorS1 = getIconNameHome(sypTemp[1]),
                           sensorS2 = getIconNameHome(jadTemp[1]),
                           sensorS3 = getIconNameHome(lazTemp[1]),
                           sensorS4 = getIconNameHome(kotTemp[1]),
                           sensorS5 = getIconNameHome(wejTemp[1]))
